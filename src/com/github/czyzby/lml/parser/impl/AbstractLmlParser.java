...
/** Provides utility methods, variables and default method implementations, allowing to create a LmlParser easier.
 *
 * @author MJ */
public abstract class AbstractLmlParser implements LmlParser, LmlSyntax {
    ...
    private static ActorConsumer<Object, Object> prepareActorConsumerForMethod(final ActionContainer actionContainer,
            final Method method) {
    ...
    private static ActorConsumer<Object, Object> prepareActorConsumerForField(final ActionContainer actionContainer,
            final Field field) {
    ...
    public void registerAttributeParser(String tagName, final LmlTagAttributeParser parser) {
        ...
        if (!tagParsers.containsKey(tagName)) {
            throw new IllegalArgumentException("Unknown tag: " + tagName + ". Cannot register attribute parser.");
        }
    ...
    public void unregisterAttributeParser(final String tagName, final String attributeName) {
        if (!tagParsers.containsKey(tagName)) {
            throw new IllegalArgumentException("Unknown tag: " + tagName + ". Cannot unregister attribute parser.");
        }
