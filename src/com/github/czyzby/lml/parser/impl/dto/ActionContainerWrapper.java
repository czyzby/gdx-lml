...
/** Wraps around an {@link com.github.czyzby.lml.parser.impl.dto.ActionContainer}, providing access to its methods and
 * fields.
 *
 * @author MJ */
public class ActionContainerWrapper {
     ...
     * @return Autumn-reflected method annotated with {@link com.github.czyzby.lml.parser.impl.annotation.ViewAction}
     *         . */
    ...
    public Method getMethod(final String methodName, final Class<?> parameterClass) throws ReflectionException {
        try {
