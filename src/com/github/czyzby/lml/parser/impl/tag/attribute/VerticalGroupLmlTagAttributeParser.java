...
public enum VerticalGroupLmlTagAttributeParser implements LmlTagAttributeParser {
    FILL_PARENT("fillParent") {
        @Override
        public void apply(final VerticalGroup verticalGroup, final LmlParser parser, final String attributeValue,
    ...
    ALIGNMENT("groupAlign") {
        @Override
        protected void apply(final VerticalGroup verticalGroup, final LmlParser parser, final String attributeValue,
                final LmlTagData lmlTagData) {
