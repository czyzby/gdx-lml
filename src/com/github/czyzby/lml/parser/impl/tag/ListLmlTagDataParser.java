...
import com.github.czyzby.lml.parser.impl.tag.attribute.ListLmlTagAttributeParser;
import com.github.czyzby.lml.parser.impl.tag.parent.ListLmlParent;

public class ListLmlTagDataParser extends AbstractWidgetLmlTagDataParser<List<String>> {
    ...
    static {
        ...
        for (final LmlTagAttributeParser parser : ListLmlTagAttributeParser.values()) {
    ...
    protected List<String> parseChildWithValidTag(final LmlTagData lmlTagData, final LmlParser parser) {
        return new List<String>(parser.getSkin(), getStyleName(lmlTagData, parser));
    }

    @Override
    protected LmlParent<List<String>> parseParentWithValidTag(final LmlTagData lmlTagData, final LmlParser parser,
            final LmlParent<?> parent) {
        return new ListLmlParent(lmlTagData, parseChild(lmlTagData, parser), parent, parser);
    }
}
