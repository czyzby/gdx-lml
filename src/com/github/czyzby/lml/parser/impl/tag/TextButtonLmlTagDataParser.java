...
/** Additionally to button and table tags, text button supports:
 * <ul>
 * <li>text - button's label text.</li>
 * <li>textAlign - button's label alignment.</li>
 * <li>textWrap - button's label wrapping setting. Use with caution. true/false.</li>
 * <li>textEllipsis - button's label ellipsis setting. true/false.</li>
 * </ul>
 *
 * @author MJ */
public class TextButtonLmlTagDataParser extends ButtonLmlTagDataParser {
    ...
    protected LmlParent<Table> parseParentWithValidTag(final LmlTagData lmlTagData, final LmlParser parser,
        ...
        return new TextButtonLmlParent(lmlTagData, (TextButton) parseChild(lmlTagData, parser), parent, parser);
    }
}
