...
public enum HorizontalGroupLmlTagAttributeParser implements LmlTagAttributeParser {
    FILL_PARENT("fillParent") {
        @Override
        public void apply(final HorizontalGroup horizontalGroup, final LmlParser parser, final String attributeValue,
                final LmlTagData lmlTagData) {
            horizontalGroup.setFillParent(LmlAttributes.parseBoolean(horizontalGroup, parser, attributeValue));
        }
    },
    ALIGNMENT("groupAlign") {
        @Override
        protected void apply(final HorizontalGroup horizontalGroup, final LmlParser parser, final String attributeValue,
                final LmlTagData lmlTagData) {
