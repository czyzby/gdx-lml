...
public class ScrollPaneLmlParent extends AbstractLmlParent<ScrollPane> {
    ...
    public void doOnTagClose(final LmlParser parser) {
        ...
        if (tagData.containsAttribute(ScrollPaneLmlTagAttributeParser.SCROLL_PERCENT_X_ATTRIBUTE)) {
            ScrollPaneLmlTagAttributeParser.SCROLL_PERCENT_X.apply(actor, parser,
                    tagData.getAttribute(ScrollPaneLmlTagAttributeParser.SCROLL_PERCENT_X_ATTRIBUTE), tagData);
        }
        if (tagData.containsAttribute(ScrollPaneLmlTagAttributeParser.SCROLL_PERCENT_Y_ATTRIBUTE)) {
            ScrollPaneLmlTagAttributeParser.SCROLL_PERCENT_Y.apply(actor, parser,
                    tagData.getAttribute(ScrollPaneLmlTagAttributeParser.SCROLL_PERCENT_Y_ATTRIBUTE), tagData);
        }
    }
