...
import com.github.czyzby.lml.parser.impl.tag.attribute.HorizontalGroupLmlTagAttributeParser;
import com.github.czyzby.lml.parser.impl.tag.parent.HorizontalGroupLmlParent;

public class HorizontalGroupLmlTagDataParser extends AbstractLmlTagDataParser<HorizontalGroup> {
    ...
    static {
        ...
        for (final LmlTagAttributeParser parser : HorizontalGroupLmlTagAttributeParser.values()) {
    ...
    @Override
    protected LmlParent<HorizontalGroup> parseParentWithValidTag(final LmlTagData lmlTagData, final LmlParser parser,
            final LmlParent<?> parent) {
        return new HorizontalGroupLmlParent(lmlTagData, parseChild(lmlTagData, parser), parent, parser);
    }
}
