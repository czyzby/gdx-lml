...
public enum TextButtonLmlTagAttributeParser implements LmlTagAttributeParser {
    HREF("href") {
        @Override
        protected void apply(final TextButton textButton, final LmlParser parser, final String attributeValue,
    ...
    TEXT_ALIGN("textAlign") {
        ...
        protected void apply(final TextButton textButton, final LmlParser parser, final String attributeValue,
                final LmlTagData lmlTagData) {
            textButton.getLabel().setAlignment(LmlAttributes.parseAlignment(textButton, parser, attributeValue));
        }
    },
