...
/** Additionally to Table tags, button supports:
 * <ul>
 * <li>isChecked: if true, button will be set to checked status.</li>
 * <li>isDisables: if true, button will be disabled.</li>
 * </ul>
 *
 * @author MJ */
