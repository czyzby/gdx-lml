...
public enum CommonLmlTagAttributeParser implements LmlTagAttributeParser,LmlSyntax {
    ...
    ON_CLICK("onClick", "click") {
        ...
        public void apply(final Actor actor, final LmlParser parser, final String attributeValue,
                final LmlTagData lmlTagData) {
            final ActorConsumer<Object, Object> action = LmlAttributes.parseAction(actor, parser, attributeValue);
    ...
    RED("r", "red") {
        ...
        protected void apply(final Actor actor, final LmlParser parser, final String attributeValue,
            ...
            actor.setColor(LmlAttributes.parseFloat(actor, parser, attributeValue), currentColor.g, currentColor.b,
                    currentColor.a);
        }
    },
    GREEN("g", "green") {
        ...
        protected void apply(final Actor actor, final LmlParser parser, final String attributeValue,
            ...
            final Color currentColor = actor.getColor();
            // getColor() returns actor's Color instance, but just to be safe - setting with Actor's API:
            actor.setColor(currentColor.r, LmlAttributes.parseFloat(actor, parser, attributeValue), currentColor.b,
                    currentColor.a);
        }
    },
    BLUE("b", "blue") {
        ...
        protected void apply(final Actor actor, final LmlParser parser, final String attributeValue,
            ...
            final Color currentColor = actor.getColor();
            // getColor() returns actor's Color instance, but just to be safe - setting with Actor's API:
            actor.setColor(currentColor.r, currentColor.g, LmlAttributes.parseFloat(actor, parser, attributeValue),
                    currentColor.a);
        }
    },
    ALPHA("a", "alpha") {
