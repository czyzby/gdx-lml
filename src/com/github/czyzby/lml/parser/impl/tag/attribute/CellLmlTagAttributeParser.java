...
public enum CellLmlTagAttributeParser implements LmlTagAttributeParser {
	...
	PAD("pad") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.pad(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	PAD_TOP("padTop") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.padTop(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	PAD_BOTTOM("padBottom") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.padBottom(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	PAD_LEFT("padLeft") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.padLeft(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	PAD_RIGHT("padRight") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.padRight(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	SPACE("space") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.space(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	SPACE_TOP("spaceTop") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.spaceTop(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	SPACE_BOTTOM("spaceBottom") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.spaceBottom(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	SPACE_LEFT("spaceLeft") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.spaceLeft(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	SPACE_RIGHT("spaceRight") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.spaceRight(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	UNIFORM("uniform") {
	...
	HEIGHT("height") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.height(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	MIN_HEIGHT("minHeight") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.minHeight(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	PREF_HEIGHT("prefHeight") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.prefHeight(LmlAttributes.parseVerticalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	...
	WIDTH("width") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.width(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	MIN_WIDTH("minWidth") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.minWidth(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	PREF_WIDTH("prefWidth") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.prefWidth(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	},
	MAX_WIDTH("maxWidth") {
		...
		protected void apply(final Cell<?> cell, final LmlParser parser, final String attributeValue,
				final LmlTagData lmlTagData) {
			cell.maxWidth(LmlAttributes.parseHorizontalValue(getCellActor(cell), cell.getTable(), parser,
					attributeValue));
		}
	};
