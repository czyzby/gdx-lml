...
public enum ProgressBarLmlTagAttributeParser implements LmlTagAttributeParser {
    ...
    VALUE("value") {
        @Override
        protected void apply(final ProgressBar progressBar, final LmlParser parser, final String attributeValue,
                final LmlTagData lmlTagData) {
    ...
    ON_COMPLETE("onComplete") {
        ...
        protected void apply(final ProgressBar progressBar, final LmlParser parser, final String attributeValue,
                final LmlTagData lmlTagData) {
            final ActorConsumer<Object, Object> action = LmlAttributes.parseAction(progressBar, parser, attributeValue);
