...
public interface LmlData {
    ...
    /** @param onChangeProcessor handles fields annotated with {@link com.github.czyzby.lml.annotation.OnChange}.
     *            By adding a custom processor, it is possible to associate new types of fields with specified widgets.
