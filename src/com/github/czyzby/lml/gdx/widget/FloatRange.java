package com.github.czyzby.lml.gdx.widget;
...
public class FloatRange {
	...
	/** @param targetValue if is not equal to previously set target value or current value, will begin
	 *            transition of current value. */
