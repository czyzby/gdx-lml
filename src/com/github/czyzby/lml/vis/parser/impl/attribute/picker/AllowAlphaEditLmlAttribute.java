...
/** See {@link ColorPicker#setAllowAlphaEdit(boolean)}. Mapped to "allowAlphaEdit", "allowAlpha".
 *
 * @author MJ */
public class AllowAlphaEditLmlAttribute implements LmlAttribute<ColorPicker> {
    @Override
