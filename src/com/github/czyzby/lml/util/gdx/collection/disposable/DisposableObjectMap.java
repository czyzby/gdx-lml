 ...
 * <br> <br> Utility container for disposable objects.
 *
 * @author Nathan Sweet
 * @author MJ */
public class DisposableObjectMap<Key, Value extends Disposable> extends ObjectMap<Key, Value> implements
		Disposable {
	...
	public static <Key, Value extends Disposable> DisposableObjectMap<Key, Value> of(
