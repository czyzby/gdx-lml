package com.github.czyzby.lml.util.gdx.collection.disposable;
...
public class DisposableObjectSet<Type extends Disposable> extends ObjectSet<Type> implements Disposable {
	/** Creates a new set with an initial capacity of 32 and a load factor of 0.8. This set will hold 25 items
	 * before growing the backing table. */
	public DisposableObjectSet() {
		super();
	}

	/** Creates a new set with a load factor of 0.8. This set will hold initialCapacity * 0.8 items before
