package com.github.czyzby.lml.util.tuple;

import java.util.Map;

/** Interface shared by both mutable and immutable double tuples. Ensures that tuples contain methods that
...
public interface DoubleTuple<First, Second> extends Map.Entry<First, Second>, Tuple {
	...
	/** @return a new pair with inverted variables order. */
	public DoubleTuple<Second, First> invert();

	/** @param third will be set as third triplet's value.
	 * @return a new TripleTuple constructed with this pair's values and another passed variable. It's
	 *         mutability should match DoubleTuple implementation. */
