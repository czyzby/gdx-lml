package com.github.czyzby.lml.util.tuple.immutable;

import java.util.Iterator;

import com.github.czyzby.lml.util.common.Nullables;
import com.github.czyzby.lml.util.tuple.DoubleTuple;
import com.github.czyzby.lml.util.tuple.TripleTuple;
import com.github.czyzby.lml.util.tuple.mutable.MutablePair;
import com.github.czyzby.lml.util.tuple.mutable.MutableTriple;
import com.github.czyzby.lml.util.tuple.util.Tuples;

/** Double tuple. Stores two variables. Immutable utility container for all these cases that two variables have
 * to be returned by a function or otherwise passed and stored together. Implements Map.Entry using first
 * variable as key and second as value for additional utility, although it doesn't allow changing its value
 * with setValue (throws AssertionError).
 *
 * @author MJ */
public class Pair<First, Second> implements DoubleTuple<First, Second> {
	...
	public boolean equals(final Object object) {
		return object == this || object instanceof DoubleTuple
				&& Nullables.areEqual(first, ((DoubleTuple<?, ?>) object).getFirst())
