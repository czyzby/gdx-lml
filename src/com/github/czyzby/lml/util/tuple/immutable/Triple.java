...
/** Triple tuple. Stores three variables. Immutable utility container for all these cases that three variables
 * have to be returned by a function or otherwise passed and stored together. Implements Map.Entry using first
 * variable as key and second as value for additional utility, although it obviously doesn't store just 2
 * values. Additionally, it doesn't allow changing its value with setValue (throws AssertionError).
 *
 * @author MJ */
public class Triple<First, Second, Third> implements TripleTuple<First, Second, Third> {
	...
	public static <First, Second, Third> Triple<First, Second, Third> ofNonNull(final First first,
