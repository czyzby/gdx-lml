package com.github.czyzby.lml.util.tuple.mutable;

import java.util.Iterator;

import com.github.czyzby.lml.util.common.Nullables;
import com.github.czyzby.lml.util.tuple.TripleTuple;
import com.github.czyzby.lml.util.tuple.immutable.Triple;
import com.github.czyzby.lml.util.tuple.util.Tuples;

/** Triple tuple. Stores three variables. Mutable utility container for all these cases that three variables
...
public class MutableTriple<First, Second, Third> implements TripleTuple<First, Second, Third> {
	...
	public static <First, Second, Third> MutableTriple<Third, Second, First> invert(
		...
		return new MutableTriple<Third, Second, First>(triple.getThird(), triple.getSecond(),
				triple.getFirst());
	}
	...
	public static <First, Second, Third> MutableTriple<Second, Third, First> shiftLeft(
			final MutableTriple<First, Second, Third> triple) {
		return new MutableTriple<Second, Third, First>(triple.getSecond(), triple.getThird(),
				triple.getFirst());
	}
