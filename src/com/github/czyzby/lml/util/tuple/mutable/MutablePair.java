...
/** Double tuple. Stores two variables. Mutable utility container for all these cases that two variables have
 * to be returned by a function or otherwise passed and stored together. Implements Map.Entry using first
 * variable as key and second as value for additional utility.
 *
 * @author MJ */
