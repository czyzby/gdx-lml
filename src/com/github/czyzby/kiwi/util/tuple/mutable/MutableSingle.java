...
/** Single tuple. Stores one variable. Mutable, iterable utility container for a single value - can be used to
 * pass a single variable when an iterable is required and expected to be somehow modified.
 *
 * @author MJ */
public class MutableSingle<Type> implements SingleTuple<Type> {
	 ...
	 * @return a new MmutableSingle holding the passed non-null value. */
