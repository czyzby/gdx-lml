...
/** Single tuple. Stores one variable. Immutable, iterable utility container for a single value - can be used
 * to pass a single variable when an iterable is required. Throws exceptions on mutating operations.
 *
 * @author MJ */
