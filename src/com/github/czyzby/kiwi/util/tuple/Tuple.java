...
public interface Tuple extends Iterable<Object>, Serializable {
	...
	/** @return a typed operator returning values of the selected class. Iteration might throws
	 *         ClassCastExceptions if pair contains other types of objects than selected. */
