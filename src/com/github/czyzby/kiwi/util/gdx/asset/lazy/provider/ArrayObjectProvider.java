...
/** Utility implementation of ObjectProvider that produces regular or, when constructed with class object,
 * typed arrays. Does not rely on reflection.
 *
 * @author MJ */
public class ArrayObjectProvider<Type> implements ObjectProvider<Array<Type>> {
	private final Class<Type> arrayType;

	/** Produces regular arrays. Note that the object is stateless and immutable, so one instance per
