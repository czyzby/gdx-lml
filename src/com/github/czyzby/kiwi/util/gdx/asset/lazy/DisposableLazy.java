 ...
 * when necessary. Concurrent use might result in multiple provider method calls. Holds a disposable object
 * and implements disposable interface for extra utility - dispose on the wrapped object will be called only
