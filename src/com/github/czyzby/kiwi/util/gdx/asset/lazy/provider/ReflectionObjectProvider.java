...
/** A simple implementation of ObjectProvider that invokes no-argument constructor of passed class on call. For
 * more complex objects providers, you still need custom implementations. Note that the class handled by the
 * provider has to be included for reflection on GWT.
 *
 * @author MJ */
public class ReflectionObjectProvider<Type> implements ObjectProvider<Type> {
	private final Class<Type> type;

	/** @param type will be the type of objects constructed by the provider. Note that the class has to have a
