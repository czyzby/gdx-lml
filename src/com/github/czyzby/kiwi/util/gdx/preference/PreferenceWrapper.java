...
/** "Abstract" implementation for the Preference interface, although the class itself is not abstract and can
 * be normally used in code. If you want to extend it though, you should know that all setter and extract
 * methods use getName method to put and get preference values from the preferences.
 *
 * Preferences are advised to be kept in an enum (which cannot extend), so this implementation might have to
 * be copied.
 *
 * @author MJ */
