...
/** A simple interface for a single game preferences. Advised to be implemented by an enum holding all relevant
 * game preferences.
 *
 * @author MJ */
public interface Preference {
	 ...
	 * @return the value connected with the preference's key present in the passed preferences or passed
