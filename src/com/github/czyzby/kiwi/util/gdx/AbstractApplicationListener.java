...
/** Works similarly to ApplicationAdapter, except it clears the screen with black color on render and calls
 * abstract render(float deltaTime) method that you have to override.
 *
 * @author MJ */
