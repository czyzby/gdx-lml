...
/** LibGDX alignments are simple integers and it's rather easy to make a mistake while using the align methods. This
 * enums wraps all default alignments, allowing to validate if the alignment value is actually correct. No word
 * separators to make constants match (ignoring case) with Align LibGDX variables (and for more natural use in LML
 * tags).
 *
 * @author MJ */
public enum Alignment {
    ...
    /** @return value from LibGDX Align class represented by this enum's constant. */
