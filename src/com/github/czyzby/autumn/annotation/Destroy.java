 ...
 * mind that parameter instances will be kept in {@link com.github.czyzby.autumn.context.ContextDestroyer} object,
 * so if you want method dependencies garbage-collected before final context destruction, remove or replace the
 * dependencies. Methods with higher priority execute first.
 *
 * @author MJ
 * @see Provider */
