...
/** Rather than extracting existing instances of components from the context, this provider will create a new component
 * instance (initiated with the context) on each {@link #provide()} call.
 *
 * @author MJ */
