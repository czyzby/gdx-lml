...
/** Interface shared by all annotation processors. Allows to determine the type of annotated field handled by the
 * processor. Note that custom processors have to extend one of abstract implementations of this class to be correctly
 * registered.
 *
 * @author MJ */
