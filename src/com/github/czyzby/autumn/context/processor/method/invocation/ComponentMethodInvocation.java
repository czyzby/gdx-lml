...
public class ComponentMethodInvocation implements Comparable<ComponentMethodInvocation> {
    ...
    /** @param priority method priority. Before processing, invocations are usually sorted by their priority and invoked
     *            one by one.
    ...
    public void invoke() {
        try {
            Reflection.invokeMethod(method, component.getComponent(), context.prepareMethodParameters(method));
