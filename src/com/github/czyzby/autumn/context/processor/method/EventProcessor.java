...
/** OnEvent annotation processor and one of core, default components. Most processors use this one for conditional
...
public class EventProcessor extends ComponentMethodAnnotationProcessor {
    ...
    /** Allows to manually post an event to a listener we hold a reference to. For extreme cases (and internal use).
     *
    ...
    public void removeUnusedListeners() {
        while (GdxArrays.sizeOf(listenersToRemove) > 0) {
            ...
            for (final Object listener : listeners) {
                ...
                eventListeners.get(((ComponentEventListener) listener).getEventType())
                        .remove((ComponentEventListener) listener);
                removedListeners++;
            }
