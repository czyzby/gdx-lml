...
public class MetaAnnotationProcessor extends ComponentMetaAnnotationProcessor {
    ...
    public void processClass(final ContextContainer context, final Class<?> componentClass) {
        ...
        if (metaComponent instanceof ComponentAnnotationProcessor) {
            ...
            throw new AutumnRuntimeException("Unable to process meta component of class: " + componentClass
    ...
    private static void injectField(final ContextContainer context, final ComponentAnnotationProcessor processor,
        ...
        if (field.isAnnotationPresent(Inject.class)) {
            ...
            if (ComponentAnnotations.isClassSet(injectionData.lazy())) {
                ...
                Reflection.setFieldValue(field, processor, context.extractFromContext(field.getType()).getComponent());
            }
        }
    }
