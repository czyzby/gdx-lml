...
public class AutumnApplication implements ApplicationListener {
    ...
    protected ClassScanner getDefaultScanner() {
        ...
        return new FixedClassScanner(
                // Assets:
                AssetService.class, SkinAssetAnnotationProcessor.class,
                // Locale:
                LocaleService.class,
                // SFX:
                MusicService.class, MusicEnabledAnnotationProcessor.class, MusicVolumeAnnotationProcessor.class,
                SoundEnabledAnnotationProcessor.class, SoundVolumeAnnotationProcessor.class,
                // Settings:
                I18nBundleAnnotationProcessor.class, PreferenceAnnotationProcessor.class, SkinAnnotationProcessor.class,
