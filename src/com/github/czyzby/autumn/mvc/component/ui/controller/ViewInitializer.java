...
public interface ViewInitializer {
	 ...
	 * @param actorMappedByIds all actions with IDs that were referenced in the LML template. Should not be
	 *            modified or assigned, copy map's values if you want to keep the references. */
