...
/** Contains runnables commonly used in Scene2D actions. Mostly for internal use: static methods often reuse
 * object and do not assume concurrent use. Make new instances of nested classes if you want to use these
 * utilities.
 *
 * @author MJ */
