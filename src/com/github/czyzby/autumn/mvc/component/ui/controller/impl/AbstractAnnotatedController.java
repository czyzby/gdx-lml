...
public abstract class AbstractAnnotatedController {
    ...
    /** Allows to specify a field that should have an actor (or multiple actors) injected each time the controlled
     * object is built.
     *
    ...
    /** Allows to specify a field holding reference to current managed {@link com.badlogic.gdx.scenes.scene2d.Stage}.
     *
