...
/** Processes {@link com.github.czyzby.autumn.mvc.stereotype.ViewDialog} components. Initiates dialog controllers.
 *
 * @author MJ */
@MetaComponent
public class ViewDialogAnnotationProcessor extends ComponentTypeAnnotationProcessor {
    ...
    public void processClass(final ContextContainer context, final Class<?> componentClass) {
        ...
        if (controller instanceof ViewDialogController) {
            interfaceService.get().registerDialogController(controller.getClass(), (ViewDialogController) controller);
        } else {
