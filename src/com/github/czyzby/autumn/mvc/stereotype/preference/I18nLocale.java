...
public @interface I18nLocale {
	/** @return path to the properties containing locale. Optional if the variable is not a string and is an
	 *         actual {@link java.util.Locale} instance. */
	String propertiesPath() default "";

	/** @return default locale that will be used if the field is a string and preferences path is given, but
	 *         there is no locale preference available. Defaults to English. Separator defaults to "-".
