 ...
 * implementing a {@link com.github.czyzby.autumn.mvc.component.ui.controller.ViewInitializer},
 ...
 * {@link com.github.czyzby.autumn.mvc.component.ui.controller.ViewPauser} and passing it in appropriate annotation
...
public @interface View {
     ...
     *         parameter should be set only if the implementation is meant to be in another class. If the class is a
     *         component, it will be extracted from the context rather than initiated. */
     ...
     *         this parameter should be set only if the implementation is meant to be in another class. If the class is
     *         a component, it will be extracted from the context rather than initiated. */
     ...
     *         implementation is meant to be in another class. If the class is a component, it will be extracted from
     *         the context rather than initiated. */
     ...
     *         {@link com.github.czyzby.lml.parser.impl.dto.ActionContainer} and ID of the screen used for screen
