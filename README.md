...
## How to start
Read on [LML](https://github.com/czyzby/gdx-lml) to see how the views are created. Check out [Autumn](https://github.com/czyzby/gdx-autumn) to find out more about the components system. You may also want to know a thing or two about [Kiwi](https://github.com/czyzby/gdx-kiwi), as these utilities might make your programming a bit easier. Then check out [example projects](https://github.com/czyzby/gdx-autumn-mvc-tests).
...
## Examples
See [test projects](https://github.com/czyzby/gdx-autumn-mvc-tests).
...
```
    compile "com.github.czyzby:gdx-autumn-mvc:1.4.$gdxVersion"
```
