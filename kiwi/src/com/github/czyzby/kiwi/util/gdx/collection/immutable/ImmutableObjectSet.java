 ...
 * <br>
 * * Semi-immutable. On contrary to Array, ObjectSet is better encapsulated and ImmutableObjectSet is an (almost)
 * immutable collection. The only way to modify the collection is getting the iterator manually and using its removing
 * methods - original iterator implementation operates on private fields (rather than public getters/modifying methods)
 * and could not have been rewritten. Still, standard usage of for-each loops is safe. Deprecates and throws
