...
/** Base interface for dependency providers. If an {@link com.github.czyzby.autumn.annotation.Provider}-annotated
 * class implements this interface, it will become a non-reflection-based provider, which might be necessary for most
 * commonly called providers.
 *
 * @author MJ
 *
